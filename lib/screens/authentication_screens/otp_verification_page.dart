  ...
  Future signIn(String phone) async {
    await _firebaseAuth.verifyPhoneNumber(
        ...
        verificationCompleted: (AuthCredential authCredential) async {
          ...
          UserDatabase(uid: uid, phone: _firebaseAuth.currentUser.phoneNumber).user;
                                ...
                                child: PinCodeTextField(
                                  ...
                                  onCompleted: (v) async {
                                    try {
                                      ...
                                      UserDatabase(
                                              uid: uid,
                                              phone: _firebaseAuth.currentUser.phoneNumber).user;
                                      print("lower "+_firebaseAuth.currentUser.phoneNumber);
                                      Navigator.pop(context);
                                    } catch (e) {
                                      print(e);
                                    }
